...
<div id="wrapper">
    <div id="header">
        ...
        <div class="search-container">
            ...
            <form action="singer?action=search" method="post">
                ...
                <button type="submit" id="search-button" class="search-button" name="action" value="Search">Search
                </button>
                <c:if test="${not empty song}">
                    <p id="myElement" style="color: red">${song}</p>
                </c:if>
            </form>
    ...
    <div id="menu">
            ...
            <li onclick="showSubNav()"><a class="drop-ttn"><i class="fa-solid fa-bars"></i></a>
                <ul id="sub-nav">
                    <c:forEach var="list" items="${list}">
                        <li>
                            <form action="/user?id=${list.id}&email=${user.getEmail()}&password=${user.getPassWord()}" method="post">
                                <button name="action" value="formEdit">Update Profile</button>
                            </form>
                        </li>
                        <li>
                            <form action="/editPassWord.jsp?id=${user.getId()}&email=${user.getEmail()}&password=${user.getPassWord()}">
        ...
        <div class="action">
            ...
            <div class="menu">
                <ul>
                    <li><a class="underlined" href="#">Name</a></li>
                    <li><a class="underlined" href="#">Account</a></li>
                    <li><a class="underlined" href="#">Account management</a></li>
                    <li><a class="underlined" href="#" onclick="showConfirmation()">Logout</a></li>
                </ul>
            </div>
        </div>
        <script>
    ...
    <div id="left">
        <div class="hover-listPlay">
            <ul>
                <a style="text-decoration: none" href="songList?action=listMusic&email=${user.getEmail()}&password=${user.getPassWord()}">
                    <li class="menu-myPlaylist" style="color: #fff">Song List</li>
                </a>
                <li class="menu-last" style="color: #fff">
                    <a class="n" href="user?action=showUser&email=${user.getEmail()}&password=${user.getPassWord()}">Admin</a>
                </li>

                <li class="menu-recommended" style="color: #fff">
                    <a class="n" href="admin?action=showUser&email=${user.getEmail()}&password=${user.getPassWord()}"
    ...
    <div id="content">
        ...
        <div class="popular_song">
            ...
            <div class="pop_song">
                ...
                <li class="songItem">
                    <div class="img_play">
                        <img src="https://dt.muvi.vn/mvn/thumbnails/song/2022/04/22/chayvekhocvoianh_20220422152624.jpg"
                             alt="alan">
